...
const controllerLetter = require('../controllers/controller.letter.js')

/* http://localhost:3000/api/letters | get all data letter from database */
router.get('/', controllerLetter.getAllLetter)
/* http://localhost:3000/api/letters | search letter and frequency */
router.get('/search', controllerLetter.searchLetter)
...
/* http://localhost:3000/api/letters | insert many document to database */
